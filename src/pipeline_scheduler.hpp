...
class PipelineScheduler
 ...
 public:
  explicit PipelineScheduler(const PipelineSchedulingOptions& options);
...
//: Validates `options` and returns the scheduler that enforces them.
