...
# @agent-public-api: ActionGenerator, ActionOutput, CancellationSource, CancellationToken, CancelledError, ComponentPlacementSpec, ComponentPrecisionReport, ConditioningFramePreprocessor, DeadlineExceededError, DeviceSpec, GeneratorPromptPacker, ImageGenerator, ImageOutput, ImagePreprocessor, LatentDynamicsModel, LegacyWorldModel, ModelMetadata, OnnxModel, PackedImage, PackedImagePreprocessor, PackedVideoPreprocessor, Pipeline, PipelineAdmissionStats, PipelineComponentStats, PipelineInputSpec, PipelineOutputSpec, PipelineSchedulingStats, PipelineSession, PipelineSessionSnapshot, PipelineStageSpec, PipelineStageStats, PipelineTelemetrySnapshot, PipelineTraceRecord, PipelineTransfer, PipelineTransferPlan, PipelineTransferStats, PrecisionPort, PreparedConditioning, PreparedReasonerInputs, PreparedVideo, PreparedWorldInputs, RawImage, RawVideo, Rollout, StageEvent, StageRun, StepResult, TensorSpec, TextGenerator, TextOutput, TextPreprocessor, VideoGenerator, VideoOutput, WorldModel, WorldModelError, WorldModelPipeline, WorldModelPreprocessor, available_execution_providers, pack_latent_tokens, register_execution_provider_library, supported_pipeline_capabilities, unpack_latent_tokens
